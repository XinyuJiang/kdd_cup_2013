...
def stringDistance_1(AuthorIdPaperId, dict_coauthor, dict_paperIdAuthorId_to_name_aff, dict_author_keywords, PaperAuthor, Author, Paper,dict_author_conference_journal,conference,journal,dict_author_paperid ):
    authorId = AuthorIdPaperId.authorId
    paperId = AuthorIdPaperId.paperId
...
def stringDistance_2(AuthorIdPaperId, dict_coauthor, dict_paperIdAuthorId_to_name_aff, dict_author_keywords, PaperAuthor, Author, Paper,dict_author_conference_journal,conference,journal,dict_author_paperid ):
    authorId = AuthorIdPaperId.authorId
    paperId = AuthorIdPaperId.paperId
...
# 判断两个url所在主域是否一样
def in_thesame_major_website(a, b):
    # row 0 and column 0 are initialized to 0 already
    i = 0
    if a[0:7] == "http://":
        a = a[7:]
